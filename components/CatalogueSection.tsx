...
export default function CatalogueSection() {
  const items = [
    ...
    },
    {
      ...
      description: "A bright, pristine kitchen with sleek surfaces, minimalistic design, and organized spaces for effortless cooking  "
    },
    {
      id: "03",
      ...
      description: "A sleek, organized workspace for sketching and illustrating, perfect for unleashing artistic creativity."
    },
    {
      id: "04",
      category: "LIVING ROOM SETUP",
      title: "Cozy and Modern Space",
      image: "/image/living.jpg",
      description: "A stylish living room setup blending comfort, elegance, and modern design for ultimate relaxation."
    },
  ]
